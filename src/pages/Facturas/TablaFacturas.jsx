...
const TablaFacturas = ({ user }) => {
  ...
  const downloadPDF = () => {
    const element = document.getElementById("factura-modal-container");
    const options = {
      margin: [10, 10, 10, 10],
      filename: `factura-${facturasGenerales[openDetallF].NumeroFactura}.pdf`,
            ...
            columns={[
              ...
              },
              {
                ...
                selector: (row, index) => (
                  ...
                  >
                    <div id="factura-modal-container">
