                    ...
                    <Card.Description>
                      <DataTable
                        columns={[
                          ...
                          {
                            name: "Fecha Emisión",
                            selector: (row) => row.FechaEmision || "N/A",
                            sortable: true,
                          },
                          {
                            name: "Fecha Vencimiento",
                            selector: (row) => row.FechaVencimiento || "N/A",
                            sortable: true,
                          },
                          {
                            name: "Monto Total",
                            selector: (row) => row.MontoTotal || "N/A",
                            sortable: true,
                          },
                          {
                            name: "Ver",
                ...
                <Grid.Row columns={2}>
                  ...
                  <Grid.Column width={12}>
                    ...
                    <p style={{ fontSize: "1.2em" }}>
                      {cotizacionSeleccionada?.Cliente.razonSocial ? (
                        cotizacionSeleccionada?.Cliente.razonSocial
                      ) : (
                      ...
                      <>
                        {cotizacionSeleccionada.Equipos.map((equipo, index) => (
                          <Segment key={index}>
                            ...
                            <p>
                              <strong>Cantidad:</strong> {equipo.cantidad}
                            </p>
                            <p>
                            ...
                            <p>
                              <strong>Total:</strong> S/.{equipo.total}
                            </p>
                          </Segment>
                        ))}
                      </>
